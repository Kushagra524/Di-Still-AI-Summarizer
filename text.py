...
# importing styles and fonts, feel free to replace with your own or remove entirely 
from streamlit_styles import inject_styles, inject_orbs, render_header, render_summary
...
<div class="hero-wrap">
    ...
    <p class="hero-sub">Paste any webpage or YouTube URL. Get a precise, structured summary in seconds.</p>
</div>
""", unsafe_allow_html=True)
